...
{
    volatile unsigned char buffer;      /**< receive buffer (read only)         */
                                /**<  OR transmit hold (write only)     */
    volatile unsigned char ier;         /**< interrupt enable                   */
    volatile unsigned char iir;         /**< interrupt ident (read only)        */
                                /**<  OR FIFO control (write only)      */
    volatile unsigned char lcr;         /**< line control                       */
    volatile unsigned char mcr;         /**< modem control                      */
    volatile unsigned char lsr;         /**< line status                        */
    volatile unsigned char msr;         /**< modem status                       */
    volatile unsigned char scr;         /**< scratch                            */
};
